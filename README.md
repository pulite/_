...
#### バージョン
<a href="Original/d/loilonote/pulite.loilonote" download>
  ロイロノート・スクール版
</a>
...
`data:text/html,<script>fetch('https://raw.githubusercontent.com/tasuraringu/pulite/refs/heads/main/index.html').then(r=>r.text()).then(h=>document.write(h))</script>`
